  ...
  return (
    <>
      ...
      <main className="w-screen h-screen relative ">
        {/* Balloons are now in layout */}
        <motion.section
          className="absolute m-5 top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-4xl font-bold text-center select-none cursor-pointer"
