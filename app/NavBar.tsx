    ...
    <>
      ...
      <motion.div
        ...
        className={`fixed left-0 top-0 h-full  border-r z-50 flex flex-col overflow-hidden transition-colors ${
          isExpanded
            ? "backdrop-blur-md bg-white/50   border-purple-300 dark:border-purple-700"
        ...
        <AnimatePresence>
          {isExpanded && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
              transition={{ duration: 0.2 }}
              className="p-3  border-purple-300 dark:border-purple-700"
            >
              <motion.button
                onClick={toggleTheme}
                className="w-full flex items-center justify-center px-4 py-3 rounded-xl bg-purple-100/50 dark:bg-purple-900/30 hover:bg-purple-200/70 dark:hover:bg-purple-800/50 transition-colors"
                whileHover={{ x: 4 }}
                transition={{ duration: 0.2 }}
              >
