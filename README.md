...
### Cool Story - Collaborative Storytelling
An innovative platform for creating collaborative stories where:
- 📝 Each participant adds 10-500 characters to continue the narrative
- 🔒 Access code system ensures controlled participation
- 👀 Previous entries are hidden to keep stories fresh and surprising
- 🌍 Bilingual support (English/Portuguese)
- ✏️ Story owners can manage their narratives with edit codes
- 📊 Stories can be set to active, completed, or archived status
